	...
	<form:form class="form-horizontal" method="post" action="awardType"
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				...
				<div class="radio">
					<label><form:radiobutton path="awardTypes" value="1" />Research
				...
				<c:if test='${semester == "Spring" || semester == "Fall"}'>
				<div class="radio">
					<label><form:radiobutton path="awardTypes" value="2" />Instructional
				...
				<c:if test='${semester == "Spring" || semester == "Fall"}'>
				<div class="radio">
					<label><form:radiobutton path="awardTypes" value="3" />Hemingway
				...
				<div class="radio">
					<label><form:radiobutton path="awardTypes" value="4" />Hemingway
				...
				<c:if test='${semester == "Spring"}'>
				<div class="radio">
					<label><form:radiobutton path="awardTypes" value="5" />Hemingway
				...
				<c:if test='${semester == "Spring"}'>
				<div class="radio">
					<label><form:radiobutton path="awardTypes" value="6" />Hemingway
				...
				<c:if test='${semester == "Spring"}'>
				<div class="radio">
					<label><form:radiobutton path="awardTypes" value="7" />Hemingway
