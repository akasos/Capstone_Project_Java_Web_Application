...
<div class="wrapper">
    ...
    <nav id="sidebar" class="sidebar">
        ...
        <ul class="list-unstyled components">
            <li><a class="btn my-btn" type="button"  onclick="window.location.href = '/eRSPG/committee/home'" value="Committee Home">Home</a></li>
            <li class="active"><a class="btn my-btn" type="button"  onclick="window.location.href = '/eRSPG/committee/reviewproposals'" value="Committee Review Proposal">Review Proposals</a></li>
        </ul>
    </nav>
...
<script type="text/javascript" src="<s:url value="/js/committeeReviewProposalList.js"/>"></script>
</body>
</html>